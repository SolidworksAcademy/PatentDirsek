...
namespace PatentDirsek
{
    public static class DocumentManager
    {
        ...
        public static void NewAssemblyTemplate() // Yeni bir part dökümanı açan metodum
        {
            SldWorks SldWorks = new SldWorks();
            ModelDoc2 swModel;

            swModel = (ModelDoc2)SldWorks.NewDocument("C:\\ProgramData\\SOLIDWORKS\\SOLIDWORKS 2019\\templates\\Montaj.asmdot", 0, 0, 0);
